...
//
// Die Reihenfolge der Spalten ist zugleich die Nummer, die als LANG ans
// Telefon geht. Neue Sprachen kommen deshalb nur HINTEN dazu - sonst spraeche
// eine alte Telefonseite mit einer neuen Uhr die falsche Sprache.
